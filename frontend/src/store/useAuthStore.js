...
// allauth headless lives at the site root (sibling of /api), so derive its
// origin from VITE_API_URL. Using URL().origin handles any API path shape
// (/api, /api/v1, trailing slash) and resolves relative values against the page.
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:8000/api';
const API_ORIGIN = new URL(API_URL, window.location.origin).origin;
const allAuthEndpoint = `${API_ORIGIN}/_allauth/app/v1/auth`;
