...
// Attribute-rich municipalities overlay. Configurable so a fork can point at its
// own FeatureServer / backend endpoint; defaults to the demo ArcGIS service.
...
const useStore = create((set, get) => ({
    ...
    fetchGeoJSONData: async () => {
        try {
            const response = await fetch(MUNI_GEOJSON_URL);
